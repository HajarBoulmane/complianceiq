  ...
  return (
    <div className="min-h-screen bg-navy dark:bg-navy-dark flex">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-[#1A1420] border-t border-slate-200 dark:border-white/10 flex items-center justify-around py-2 z-10">
        ...
        <Link to="/ask" className="flex flex-col items-center gap-0.5 px-3 py-1 text-slate-500 dark:text-slate-400">
          <MessageSquareText size={20} />
          <span className="text-[10px]">Question</span>
        </Link>
        <Link to="/analyze" className="flex flex-col items-center gap-0.5 px-3 py-1 text-slate-500 dark:text-slate-400">
          <FileSearch size={20} />
          <span className="text-[10px]">Analyser</span>
        </Link>
        <button onClick={handleLogout} className="flex flex-col items-center gap-0.5 px-3 py-1 text-slate-500 dark:text-slate-400">
          <LogOut size={20} />
